...
//        }
    ...
    private ResearchResultSetItem buildVitalResultSet(List<? extends IResearchEncounter> encounters, ResearchFilterItem filters) {
        ...
        for (IResearchEncounter encounter : encounters) {
            ...
            secondaryDataHelper(encounter, patient, filters, resultSet, resultItem);
    ...
    private void secondaryDataHelper(IResearchEncounter encounter, IPatient patient, ResearchFilterItem filters, ResearchResultSetItem resultSet, ResearchResultItem resultItem){
